...
int boardRows = 12;             // Rows: usually 12 for MoonBoard Mini, 18 for a standard MoonBoard
#elif defined(MOONBOARD_STANDARD)
const uint16_t ledsCount = 200; // Leds count
String boardName = "Standard";  // Moonboard name
int boardRows = 18;             // Rows: usually 12 for MoonBoard Mini, 18 for a standard MoonBoard
#endif
